...
operator-test: schema buffer slottedpages operator testing
	$(LD) $(LDFLAGS) -o operator-test ./testing/operatortest.o ./operator/Register.o ./operator/TableScan.o ./slottedpages/SPSegment.o ./slottedpages/Record.o ./schema/Schema.o ./schema/SchemaManager.o ./buffer/BufferManager.o ./buffer/BufferFrame.o
